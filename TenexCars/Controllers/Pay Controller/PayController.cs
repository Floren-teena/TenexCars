...
namespace TenexCars.Controllers.Pay_Controller
{
    public class PayController : Controller
    {
        ...
        public PayController(IConfiguration configuration, ApplicationDbContext dbContext)
        {
        ...
        public IActionResult Index(string vehicleId)
        {
            ...
            var vehicleRequest = _dbContext.VehicleRequests
        ...
        public async Task<IActionResult> Index(PayViewModel pay)
        {
            ...
            if (response.Status)
            {
                var vehicleRequest = _dbContext.VehicleRequests.FirstOrDefault(vr => vr.VehicleId == pay.VehicleId);
        ...
        public async Task<IActionResult> Verify(string reference)
        {
            try
            {
                ...
                {
                    var transaction = _dbContext.Transactions.FirstOrDefault(x => x.TrxRef == reference);
                    if (transaction != null)
                    {
